...
If you want to transfer your domain in from an external registrar to ZEIT, you can do that painlessly without worrying about domain and DNS configuration. This document will walk you through how to transfer your domain in with ZEIT Now in a few steps.
