...
<Note>
  This only applies to domains you bought via ZEIT Now or domains configured
  with our <GenericLink href="/dns">global DNS service</GenericLink>.
</Note>
...
>
> 1. use a custom certificate for your ZEIT Now deployment with `now certs issue --ca`
> 2. run an app outside of ZEIT Now with TLS for a subdomain
