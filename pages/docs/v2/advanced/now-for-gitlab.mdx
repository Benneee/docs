...
You can connect your ZEIT Now account to GitLab by visiting your [account or team](/docs/v2/advanced/platform/users-and-teams) [settings page](/account) and clicking the "Connect with GitLab" button.
